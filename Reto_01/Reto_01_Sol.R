# Reto 1. Gráfica de series de tiempo
...
# 1. Creé un data frame para el Barcelona que indique el número de goles
# anotados en cada fecha que ha jugado.

# 2. Obtenga un data frame que indique el promedio de goles anotados en cada
# mes que ha jugado

# 3. Creé una serie de tiempo mensual para el número promedio de goles 
# anotados por el Barcelona

# 4. Realice los pasos 1 a 3 para el Real Madrid

# 5. Muestre en una misma imagen las gráficas de las series de tiempo
# anteriores
...
barca <- ts(barca$goles, start = c(2017, 8), frequency = 12, 
            end = c(2020, 7)) 
...
realM <- ts(realM$goles, start = c(2017, 8), 
            frequency = 12, end = c(2020, 7))
